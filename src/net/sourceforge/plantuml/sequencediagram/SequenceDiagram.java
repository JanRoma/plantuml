...
public class SequenceDiagram extends UmlDiagram {
	...
	public final void autonumberNoDecimal(DottedNumber startingNumber, int increment, DecimalFormat decimalFormat) {
//			Integer numberInt = Integer.parseInt(startingNumber.toString());
			String stringCurrentNumber = autoNumber.getCurrentMessageNumber(false);

			stringCurrentNumber = stringCurrentNumber.substring(0,stringCurrentNumber.indexOf("."));
			Integer i = Integer.parseInt(stringCurrentNumber);
			i++;


			DottedNumber dn = DottedNumber.create(i.toString());
			autoNumber.go(dn, increment, decimalFormat);
	}
